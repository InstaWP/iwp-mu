...
if ( ! class_exists( 'INSTAWP_HELPER_Hooks' ) ) {
	...
	class INSTAWP_HELPER_Hooks {
		...
		function add_admin_bar_timer( WP_Admin_Bar $admin_bar ) {
			...
			$remaining_secs     = (int) Utils::get_args_option( 'remaining_secs', $site_status );
			$remaining_secs_arr = instawp_get_time_left( $remaining_secs );

			$remaining_days    = (int) Utils::get_args_option( 'days', $remaining_secs_arr );
			$remaining_hours   = (int) Utils::get_args_option( 'hours', $remaining_secs_arr );
			$remaining_minutes = (int) Utils::get_args_option( 'minutes', $remaining_secs_arr );
