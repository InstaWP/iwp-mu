	...
	class IWP_MU {
		...
		public function enqueue_timer_assets() {
			...
			$css = '
				...
				#wpadminbar .iwp-expiry-timer-node .iwp-logo-icon {
					color: #fff;
				}
				#wpadminbar .iwp-expiry-timer-node .iwp-timer-text {
					font-size: 13px;
			...
			$js = '
				(function() {
					function updateTimer() {
						var elements = document.querySelectorAll(".iwp-timer-text[data-seconds]");
